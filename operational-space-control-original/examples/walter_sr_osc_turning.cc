...
int main(int argc, char** argv) {
    ...
    while(current_time < simulation_time) {
        ...
        // =========================================================
        double shin_rot_vel_left = 0.5; 
        double shin_rot_vel_right = -0.5; 
        ...
        // Kinematic Targets
        double tl_angular_position_target = initial_tl_angular_position + shin_rot_vel_left * current_time + phase_offset;
        double tr_angular_position_target = initial_tr_angular_position + shin_rot_vel_right * current_time + phase_offset;
        double hl_angular_position_target = initial_hl_angular_position + shin_rot_vel_left * current_time;
        double hr_angular_position_target = initial_hr_angular_position + shin_rot_vel_right * current_time;
        ...
        double tl_angular_velocity_error = shin_rot_vel_left - tl_angular_velocity;
        double tr_angular_velocity_error = shin_rot_vel_right - tr_angular_velocity;
        double hl_angular_velocity_error = shin_rot_vel_left - hl_angular_velocity;
        double hr_angular_velocity_error = shin_rot_vel_right - hr_angular_velocity;
        ...
        double thigh_lin_kp = 100.0; 
        double thigh_lin_kv = 20.0; 
        ...
        logger.log("tl_shin_ang_vel", tl_angular_velocity); logger.log("tl_ang_vel_targ", shin_rot_vel_left);
        logger.log("tr_shin_ang_vel", tr_angular_velocity); logger.log("tr_ang_vel_targ", shin_rot_vel_right);
        logger.log("hl_shin_ang_vel", hl_angular_velocity); logger.log("hl_ang_vel_targ", shin_rot_vel_left);
        logger.log("hr_shin_ang_vel", hr_angular_velocity); logger.log("hr_ang_vel_targ", shin_rot_vel_right);
